...
var agents = [agent, agent1, agent2, agent3, agent4, agent5, agent6, agent7, agent8, agent9, agent10]

//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func totalOfCompromisedAgents() -> Int {
...
print("\(totalOfCompromisedAgents()) agents have been compromised!")
...
print("\(cleanAgents.count) clean agrnts out of \(agents.count) total agents")
...
func accessClassTotals() {
    var lowClassLevelAgentTotal = 0
    var midClassLevelAgentTotal = 0
    var highClassLevelAgentTotal = 0
    
    for agent in agents {
        switch agent.accessLevel {
        case 0...4:
            lowClassLevelAgentTotal += 1
        case 5...7:
            midClassLevelAgentTotal += 1
        case 8...10:
            highClassLevelAgentTotal += 1
        default:
            print("default")
        }
    }
    print("\(lowClassLevelAgentTotal) low level agents, \(midClassLevelAgentTotal) mid level agents, and \(highClassLevelAgentTotal) high level agents")
}
...
let cereal = (name: "Frostes Flakes", aisle: 2, category: "cereals", count: 43)
...
let rice = (name: "Minute Rice", aisle: 4, category: "dry rice and beans", count: 62)
