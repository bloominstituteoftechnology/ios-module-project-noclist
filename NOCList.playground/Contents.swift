...
var numberOfCompromisedPpl = 0
func compCounter() -> Int {
    for agent in agents {
        if agent.compromised {
            numberOfCompromisedPpl += 1
        }
    }
    return numberOfCompromisedPpl
}
...
compCounter()
print("\(numberOfCompromisedPpl) agents have been compromised!")
...
print("\(lowLevel) low level agents")
print("\(midLevel) mid level agents")
print("\(highLevel) high level agents")
}
