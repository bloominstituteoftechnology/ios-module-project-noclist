...
let eugeneKittridge = (coverName: "Eugene Kittridge", realName: "Henry Czerny", accessLevel: 10, compromised: false)
...
print("\(count) agents have been compromised!")
//: ## Step 5
...
print("\(cleanAgents.count) clean agents out of \(agents.count)")
//: ## Step 7
