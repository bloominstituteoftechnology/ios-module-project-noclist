...
let lutherStuckell = (coverName: "Luther Stickell", realName: "Ving Rhames", accessLevel: 4, compromised: false)
...
print("\(findCleanAgents()) clean agents out of \(agentsArray.count) total agents")
...
func agentsLevel() {
    ...
    print("\(lowLevel) agents are low level")
    print("\(midLevel) agents are mid level")
    print("\(highLevel) agents are high level")
}
//: ## Step 10
