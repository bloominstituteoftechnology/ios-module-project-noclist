...
let sarahDavis = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 5, compromised: true)
...
let agents = [ethanHunt, jimPhelps, clairePhelps, eugeneKittridge, franzKrieger, lutherStickell, sarahDavis, maxRotGrab, hannahWilliams, jackHarmon, frankBarnes]


//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.

func findBadAgents() -> Int {
    var badAgents = 0
    for agent in agents {
...
print("\(findBadAgents()) agents have been compromised!")
