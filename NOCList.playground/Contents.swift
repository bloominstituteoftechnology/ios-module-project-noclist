...
let agent6 = (coverName:  "Luther Stickwell", realName: "Ving Rhames",          accessLevel: 4, compromised:  false )
...
let compromisedAgents = findTotalCompromisedAgents()
