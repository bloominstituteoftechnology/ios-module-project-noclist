...
var agents = [ethan, jim, claire, eugene, franz, luther, sarah, max, hannah, jack, frank]

//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.

func totalCompAgents() -> Int {
    var compAgents = 0
...
totalCompAgents()
print("\(totalCompAgents()) agents have been compromised!")
...
print("\(findCleanAgents()) clean agents out of \(totalAgents) total agents")
//: ## Step 7
...
func findHighRisk(){
         for agent in agents {
            if agent.accessLevel >= 8 {
                ...
                print("Agent is not compromised")
            }
         }
     }
...
func printAscend() {
    agents.sort(coverName: String, realName: String, accessLevel: Int, compromised: Bool)
