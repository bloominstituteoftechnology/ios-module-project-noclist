...
// Alternatively, you could skip the parameter names and just have the data type (when the return type is a tuple).
...
//let tuple: (String, String, Int) = ("MacBook", "Pro", 2019)
//let nameTuple: (name: String, model: String, year: Int) = (name: "MacBook", model: "Pro", year: 2019)
//
//tuple[1]
//print(nameTuple[0])
//: ## Step 6
...
//Alternatively, you could just call 'findCleanAgents().count' instead of setting it to a variable first.
//: ## Step 7
...
// More concise way to do it below.
func findHighRisk () {
    for agent in agentArray {
...
//    }
//
//    print("\(low.count) low level agents, \(mid.count) mid level agents, \(high.count) high level agents")
//}
...
func printSortedAgentInfo () {
    let sortedAgentArray = agentArray.sorted { $0.accessLevel < $1.accessLevel }
