...
let NOC1 = (coverName: "Ethan Hunt", realName: "Tom Cruise", accessLevel: 8, compromised: false)
let NOC2 = (coverName: "Jim Phelps", realName: "Jon Voight", accessLevel: 9, compromised: true)
let NOC3 = (coverName: "Claire Phelps", realName: "Emmanuelle Beart", accessLevel: 5, compromised: false)
let NOC4 = (coverName: "Eugene Kittridge", realName: "Henry Czerny", accessLevel: 10, compromised: true)
let NOC5 = (coverName: "Franz Krieger", realName: "Jean Reno", accessLevel: 4, compromised: false)
let NOC6 = (coverName: "Luther Stickell", realName: "Ving Rhames", accessLevel: 4, compromised: false)
let NOC7 = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 5, compromised: true)
let NOC8 = (coverName: "Max RotGrab", realName: "Vanessa Redgrave", accessLevel: 4, compromised: false)
let NOC9 = (coverName: "Hannah Williams", realName: "Ingeborga Dapkūnaitė", accessLevel: 5, compromised: true)
let NOC10 = (coverName: "Jack Harmon", realName: "Emilio Estevez", accessLevel: 6, compromised: true)
let NOC11 = (coverName: "Frank Barnes", realName: "Dale Dye", accessLevel: 9, compromised: false)



//: ## Step 2
//: Place the above constants inside an array. Declare this array as a constant as well.
let NOCarray = [NOC1, NOC2, NOC3, NOC4, NOC5, NOC6, NOC7, NOC8, NOC9, NOC10, NOC11]


//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func determineCompCount() -> Int {
    var totalCompCount = 0
    for compAgent in NOCarray {
        if compAgent.compromised == true {
            totalCompCount += 1
        }
    }
...
print("\(determineCompCount()) agents have been compromised!")
...
func findCleanAgents() -> Array <String> {
    var compAgentArray : [String] = []

    for cleanAgent in NOCarray {
       if cleanAgent.compromised == false {
           print(cleanAgent.coverName)
       }

       else {
           compAgentArray.append(cleanAgent.coverName)
       }
        
}
    return compAgentArray
}
...
print(NOCarray.count)
print(findCleanAgents().count)
var totalCleanAgentNumber = NOCarray.count - (findCleanAgents().count)
print("\(totalCleanAgentNumber) clean agents out of \(NOCarray.count) total agents")
...
func findHighRisk() {
    for agentLevel in NOCarray {
        if agentLevel.accessLevel >= 8 && agentLevel.compromised == true {
            print("\(agentLevel.realName) \(agentLevel.accessLevel) **WARNING** **COMPROMISED**")
        }
        else {
            print("\(agentLevel.realName) \(agentLevel.accessLevel)")
        }
...
var countdown = NOCarray.count
    while countdown > 0 {
    
    for nonsense in NOCarray {
        if nonsense.accessLevel == countdown {
            print("\(nonsense.coverName) is Level \(countdown)") }
