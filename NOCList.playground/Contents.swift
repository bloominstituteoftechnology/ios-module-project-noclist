...
let agent7 = (coverName: "Sarah Davies", realName: "Kristin Scott Thomas", accessLevel: 4, compromised: false)
...
let agent10 = (coverName: "Jack Harmon", realName: "Emilio Estevex", accessLevel: 6, compromised: true)
let agent11 = (coverName: "Frank Barnes", realName: "Dale Dye", accessLevel: 9, compromised: false)
//: ## Step 2
//: Place the above constants inside an array. Declare this array as a constant as well.
var nocListArray: [((coverName: String, realName: String, accessLevel: Int, compromised: Bool))] = [agent1, agent2, agent3, agent4, agent5, agent6, agent7, agent8, agent9, agent10, agent11]
//: ## Step 3
//: Create a function that calculates the total number of compromised agents. Inside the function, iterate over the array of agents to determine which ones are compromised. Return the total count.
func compromisedAgents() -> Int {
    var totalCompromised = 0
    
    for agent in nocListArray {
...
findCleanAgents()
print("\(findCleanAgents().count) clean agents out of \(nocListArray.count) total agents.")
//: ## Step 7
